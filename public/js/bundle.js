...
var showAlert = function showAlert(type, msg) {
  hideAlert(); // TYPE IS success or error
...
},{}],"userActions.js":[function(require,module,exports) {
"use strict";
      ...
      while (1) {
        switch (_context2.prev = _context2.next) {
          ...
          case 3:
            ...
            if (res.data.status === "Success") {
              (0, _alerts.showAlert)("success", "Logged Out Succesfull");
              setTimeout(function () {
...
var displayMap = function displayMap(locations) {
  mapboxgl.accessToken = "pk.eyJ1IjoiY2VheGVyIiwiYSI6ImNraWZ3b2p2ejI3MGkzNG54b2J4eGEyMzQifQ.7gZRUmdZ0bHIZbdOgDXAew";
  ...
  locations.forEach(function (loc) {
    ...
    el.classList.add("marker"); // ADD MARKER
    ...
    new mapboxgl.Popup({
      offset: 30
    }).setLngLat(loc.coordinates).setHTML("<p>Day ".concat(loc.day, ": ").concat(loc.description, "</p>")).addTo(map); // EXTEND THe MAP BOUND TO ShOW THE CURRENT LOCATION
    ...
    return regeneratorRuntime.wrap(function _callee$(_context) {
      while (1) {
        switch (_context.prev = _context.next) {
          case 0:
            _context.prev = 0;
            stripe = Stripe("pk_test_51Jtad3Cwtn9e5snmkaRVv6iu3JIN8XWCLsmoeRsbS81kovOZ40wWUIzsI59EY3LPx7q8jWIlxN6g8RLPpz3QclPN009K3kkmfv"); // 1) GET CHECKOUT SESSION FROM API
...
if (formSignup) {
  formSignup.addEventListener("submit", /*#__PURE__*/function () {
    var _ref = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee(e) {
      var btn, name, email, password, confirmPassword, formData, res;
      return regeneratorRuntime.wrap(function _callee$(_context) {
        while (1) {
          switch (_context.prev = _context.next) {
            case 0:
              e.preventDefault();
              btn = formSignup.querySelector("button");
              ...
              if (e.target.photo.files.length) formData.append("photo", e.target.photo.files[0]);
              _context.prev = 13;
              _context.next = 16;
              return (0, _axios.default)({
                method: "post",
...
if (formLogin) {
  formLogin.addEventListener("submit", function (e) {
    ...
    (0, _userActions.login)(email, password);
  });
}

var logoutBtn = document.querySelector(".nav__el--logout");
if (logoutBtn) logoutBtn.addEventListener("click", _userActions.logout);
...
var formUpdateData = document.querySelector(".form--updateData");
...
var formUpdatePassword = document.querySelector(".form--updatePassword");
